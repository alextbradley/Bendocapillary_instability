...
In this appendix, we present an asymptotic analysis of the eigenvalue problem~\eqref{E:Asymptotics:ODEwet}--\eqref{E:Asymptotics:ODEwet} which emerges from the full problem~\eqref{E:LSA:ODEwet}--\eqref{E:LSA:kinematic} in the case that $\epsilon \sim \kappa^2$. Recall that to make progress, we pose an asymptotic expansion in powers of $\epsilon^{1/2}$
\begin{align}
G(X) &=    G_0 + \epsilon^{1/2} G_1 + \epsilon G_2+ \dots, \label{A:E:G_expansion}\\
Q(X) &=  Q_0 + \epsilon^{1/2} Q_1 + \epsilon Q_2+\dots,\label{A:E:Q_expansion}\\
\sigma(k) &= \sigma_0 + \epsilon^{1/2} \sigma_1 + \epsilon \sigma_2+ \dots. \label{A:E:sigma_expansion}
\end{align}

After introducing~\eqref{A:E:G_expansion}--\eqref{A:E:sigma_expansion} into~\eqref{E:Asymptotics:ODEwet}--\eqref{E:Asymptotics:ODEwet}, we obtain a hierarchy of problems by balancing powers of $\epsilon^{1/2}$. The leading order ($\order{1}$) problem reads
\begin{align}
